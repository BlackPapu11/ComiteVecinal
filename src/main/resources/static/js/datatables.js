 ...
 *   https://datatables.net/download/#bs4/jq-3.6.0/dt-1.11.5/r-2.2.9/sb-1.3.2
 *
 * Included libraries:
 *   jQuery 3 3.6.0, DataTables 1.11.5, Responsive 2.2.9, SearchBuilder 1.3.2
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.models.oSearch = {
		...
		DataTable.ext = _ext = {
			 ...
			 *  @type string
			 */
			build:"bs4/jq-3.6.0/dt-1.11.5/r-2.2.9/sb-1.3.2",
